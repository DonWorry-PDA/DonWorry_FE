    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="flex flex-1 flex-col px-6 pt-8">
        ...
        <div className="mt-10 flex flex-col gap-8">
          <div>
            <p className="text-sub text-ink-sub mb-2">목표 생활비 (월)</p>
            <div className="border-line flex items-baseline gap-2 border-b pb-3">
              <input
                type="number"
                value={living}
          ...
          <div>
            <p className="text-sub text-ink-sub mb-2">예상 의료비 (월)</p>
            <div className="border-line flex items-baseline gap-2 border-b pb-3">
              <input
                type="number"
                value={medical}

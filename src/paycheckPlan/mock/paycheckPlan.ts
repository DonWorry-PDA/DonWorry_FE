...
export const mockComparisonTable: ComparisonTable = {
  columns: [
    { planId: 'stable', planName: '안정 월급형' },
    { planId: 'balanced', planName: '균형 월급형' },
  ],
  rows: [
    { label: '예상 월수입', values: ['170만원', '185만원'] },
    { label: '생활비 충당', values: ['77%', '84%'] },
    { label: '세후 실수령', values: ['166만원', '179만원'] },
    { label: '시장이 10% 내리면', values: ['월급 그대로', '월급 −4만원'] },
    { label: '중도 해지', values: ['일부 만기 제약', '언제든 가능'] },
    { label: '수수료 (연)', values: ['0.18%', '0.31%'] },
    {
      label: '2년 내 큰돈',
      values: ['대비됨', '대비됨'],
      tones: ['success', 'success'],
      isBadge: true,
    },
    {
      label: '생활 안정도',
      values: ['보완 필요 유지', '안정으로 상승'],
      tones: ['warning', 'success'],
      isBadge: true,
    },
  ],
  notice:
